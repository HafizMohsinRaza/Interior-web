...
function FreelancerBar2() {
  ...
  return (
    <Flex as="nav" align="center" justify="space-between" p={4} bg="gray.200">
      ...
      >
        <Link to="/freelAccount" style={{ textDecoration: "none" }}>
          <Text
            as="span"
            color={inactiveColor}
        ...
        <Link to="/freelProjects" style={{ textDecoration: "none" }}>
          <Text
            as="span"
            color={activeColor}
            _hover={{ color: "gray.800" }}
        ...
        <Link to="/leads" style={{ textDecoration: "none" }}>
          <Text as="span" color={inactiveColor} _hover={{ color: "gray.800" }}>
            Leads
          </Text>
        </Link>
      </Box>
