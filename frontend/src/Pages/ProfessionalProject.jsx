...
import ProfessionalBar2 from "./ProfessionalBar2";
...
const ProfessionalProject = () => {
  ...
  const [bandfProjectType, setBandfProjectType] = useState(null);
